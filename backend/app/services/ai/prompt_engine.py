...
## 任务
为了让故事更贴合这个人的内心，请提出 2-3 个个性化选择题，帮助 AI 在生成故事时更了解用户的期望。

问题应聚焦于：
1. 故事中的关键人物（谁对主角影响最深？）
2. 故事的核心挑战或转折（这段旅程中最大的考验是什么？）
3. 故事的情感基调（整体氛围偏向哪种风格？）

每个问题提供 3-4 个差异化的选项，让用户的选择能显著影响故事走向。
...
请以 JSON 格式输出：
{
  "questions": [
    {
      "id": "q1",
      "question": "这段旅程中，谁对你影响最深？",
      "hint": "TA 的出现将成为故事的支柱",
      "options": ["一位志同道合的朋友", "一位严苛的导师", "一段短暂却深刻的爱情", "自己一个人走完这段路"]
    }
  ]
}""",
