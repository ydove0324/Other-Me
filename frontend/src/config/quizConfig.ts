            ...
            children: [
              {
                ...
                options: [
                  { id: 'dog', label: '狗' },
                  { id: 'cat', label: '猫' },
                  { id: 'pet_other', label: '其他', isCustomInput: true },
                ],
              },
            ],
          },
                    ...
                    children: [
                      {
                        ...
                        options: [
                          ...
                          { id: 'family_knot_custom', label: '自定义', isCustomInput: true },
                        ],
                      },
                    ],
                  },
                    ...
                    children: [
                      {
                        ...
                        options: [
                          ...
                          { id: 'partner_conflict_custom', label: '自定义', isCustomInput: true },
                        ],
                      },
                    ],
                  },
            ...
            children: [
              {
                ...
                options: [
                  ...
                  { id: 'health', label: '健康' },
                  { id: 'growth', label: '成长' },
                  { id: 'self_focus_custom', label: '自定义', isCustomInput: true },
                ],
              },
            ],
          },
            ...
            children: [
              {
                ...
                options: [
                  ...
                  { id: 'undone_custom', label: '自定义', isCustomInput: true },
                ],
              },
            ],
          },
...
>>>>>>> Stashed changes
            ...
            children: [
              {
                ...
                type: 'single',
                options: [
                  { id: 'shower_song_input', label: '让我输入', isCustomInput: true },
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'self_label_custom', label: '自定义', isCustomInput: true },
        ],
      },
      {
        id: 'anonymous_place',
        title: '如果完全没人认识你，想去哪待一天？',
        type: 'single',
        options: [
          {
            id: 'seaside',
            ...
            children: [
              {
                ...
                options: [
                  ...
                  { id: 'for_whom_custom', label: '自定义', isCustomInput: true },
                ],
              },
            ],
          },
